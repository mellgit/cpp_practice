...
int main()
{
    ...
    дек - двусторонняя очередь (double ended queue - deque)
    левый конец дека(начало), правый конец дека(конец)
    добавлять и извлекать элементы из дека, можно с обеих сторон
    у каждого конца мб ограниченный функционал, на вход или на выход
    в STL можно делать вставку в середину очереди, похож на двусвязный список, разница только в скорости
    и установленных ограничениях очереди
    */
    return 0;
}